    ...
    contains
     subroutine set_inputdata(this)
      ...
      class(sys_re_input)::this
       ...
       read(1,*) this%xf,this%xg,this%xs,this%acf,this%height,this%pd,this%npin,this%nf,this%ng,this%ns,this%ny,this%ny_start,this%ny_end,this%f,this%Tin,this%pout,this%uin,this%pin,this%Ti,this%ui,this%pi,this%alpha,this%sigma
       close(1)
       write(*,*)'read the data from the input file:'
       write(*,*) this%xf,this%xg,this%xs,this%acf,this%height,this%pd,this%npin,this%nf,this%ng,this%ns,this%ny,this%ny_start,this%ny_end,this%f,this%Tin,this%pout,this%uin,this%pin,this%Ti,this%ui,this%pi,this%alpha,this%sigma
