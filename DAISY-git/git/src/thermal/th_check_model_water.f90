...
contains
    ...
    subroutine Driving_th_check_model ()
        ...
        do i = 1, SIZE(geom_assm)
            ...
            geom_assm(i)%is_hexagonal = .FALSE.
        end do
        ...
        ! TH input
        design%tmaxcoolout      = 610.0                                         ! k
        design%tmincoolout      = 600.0                                         ! k
        design%tcoolin          = 557.0                                         ! k
        design%tcoolout         = 610.0                                         ! k
        ...
        call avg_channel%print_rod (500, nth, ir=1)
        ...
        do istep = 1, nstep
            ...
            if (istep <= 5)  then
                ...
                call avg_channel%print_rod (500+istep, nth, ir=1)
            end if
        end do 
...
end module th_check_model_water
