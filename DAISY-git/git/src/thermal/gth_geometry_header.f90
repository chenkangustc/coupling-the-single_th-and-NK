...
contains
    ...
    subroutine Set_TypeGeometryAssembly (this, nth)
        ...
        ! ----------------------------------------------------------------------
		! ----------------------------------------------------------------------
        ! imp: pin radial mesh point solid
        ! 
        ! !<-----------pellet------------------>|<--gap-->|<-----clad---------->||<--fluid-->|
        ! .___________._______.______._________.__________.________.____________.____________.
        !       1         2       ...     Nf       1          1  ...   nc          nf+ng+nc+1
        ! |<---df---->|                         |<--dg--->|        |<---dc---- >|
        !
        ! ----------------------------------------------------------------------
