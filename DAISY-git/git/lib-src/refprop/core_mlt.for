...
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: MELTT
c     dll_export MELTT
c
      parameter (ncmax=20)        !max number of components in mixture
      parameter (nrefmx=10)       !max number of fluids for transport ECS
...
c
      ...
      implicit integer (i-k,m,n)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: MELTP
c     dll_export MELTP
c
      parameter (ncmax=20)        !max number of components in mixture
      parameter (nrefmx=10)       !max number of fluids for transport ECS
...
c
      ...
      implicit integer (i-n)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: MLTH2O
c     dll_export MLTH2O
c
      p1=0.0d0
      p2=0.0d0
...
c
      ...
      implicit integer (i-k,m,n)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: SUBLT
c     dll_export SUBLT
c
      parameter (ncmax=20)        !max number of components in mixture
      parameter (nrefmx=10)       !max number of fluids for transport ECS
...
c
      ...
      implicit integer (i-k,m,n)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: SUBLP
c     dll_export SUBLP
c
      parameter (ncmax=20)        !max number of components in mixture
      parameter (nrefmx=10)       !max number of fluids for transport ECS
