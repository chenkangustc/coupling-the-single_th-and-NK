...
c
      ...
      implicit logical (l)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: CRITP
c     dll_export CRITP
c
...
c
      ...
      implicit logical (l)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: THERM
c     dll_export THERM
c
      character*3 hpheq,heos,hmxeos,hmodcp
      parameter (ncmax=20)        !max number of components in mixture
...
c
      ...
      implicit logical (l)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: THERM2
c     dll_export THERM2
c
      character*3 hpheq,heos,hmxeos,hmodcp
      parameter (ncmax=20)        !max number of components in mixture
...
c
      ...
      implicit logical (l)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: THERM0
c     dll_export THERM0
c
      character*3 hpheq,heos,hmxeos,hmodcp
      parameter (ncmax=20)        !max number of components in mixture
...
c
      ...
      implicit logical (l)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: RESIDUAL
...
c
      ...
      implicit logical (l)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: ENTRO
c     dll_export ENTRO
c
      character*3 hpheq,heos,hmxeos,hmodcp
      parameter (ncmax=20)        !max number of components in mixture
...
c
      ...
      implicit logical (l)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: ENTHAL
c     dll_export ENTHAL
c
      character*3 hpheq,heos,hmxeos,hmodcp
      parameter (ncmax=20)        !max number of components in mixture
...
c
      ...
      implicit logical (l)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: ENERGY
c     dll_export ENERGY
c
      character*3 hpheq,heos,hmxeos,hmodcp
      parameter (ncmax=20)        !max number of components in mixture
...
c
      ...
      implicit logical (l)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: CVCP
c     dll_export CVCP
c
      character*3 hpheq,heos,hmxeos,hmodcp
      parameter (ncmax=20)        !max number of components in mixture
...
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: CVCPK
c     dll_export CVCPK
c
      character*3 hpheq,heos,hmxeos,hmodcp
      parameter (ncmax=20)        !max number of components in mixture
...
c
      ...
      implicit logical (l)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: GIBBS
c     dll_export GIBBS
c
      character*3 hpheq,heos,hmxeos,hmodcp
      parameter (ncmax=20)        !max number of components in mixture
...
c
      ...
      implicit logical (l)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: AG
c     dll_export AG
c
      character*3 hpheq,heos,hmxeos,hmodcp
      parameter (ncmax=20)        !max number of components in mixture
...
c
      ...
      implicit logical (l)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: PRESS
c     dll_export PRESS
c
      character*3 hpheq,heos,hmxeos,hmodcp
      parameter (ncmax=20)        !max number of components in mixture
...
c
      ...
      implicit logical (l)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: DPDD
c     dll_export DPDD
c
      character*3 hpheq,heos,hmxeos,hmodcp
      parameter (ncmax=20)        !max number of components in mixture
...
c
      ...
      implicit integer (i-n)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: DPDDK
c     dll_export DPDDK
c
      character*3 hpheq,heos,hmxeos,hmodcp
      parameter (ncmax=20)        !max number of components in mixture
...
c
      ...
      implicit logical (l)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: DPDD2
c     dll_export DPDD2
c
      character*3 hpheq,heos,hmxeos,hmodcp
      parameter (ncmax=20)        !max number of components in mixture
...
c
      ...
      implicit integer (i-n)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: DPDT
c     dll_export DPDT
c
      character*3 hpheq,heos,hmxeos,hmodcp
      parameter (ncmax=20)        !max number of components in mixture
...
c
      ...
      implicit integer (i-n)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: DPDTK
c     dll_export DPDTK
c
      character*3 hpheq,heos,hmxeos,hmodcp
      parameter (ncmax=20)        !max number of components in mixture
...
c
      ...
      implicit integer (i-n)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: DDDP
c     dll_export DDDP
c
      character*3 hpheq,heos,hmxeos,hmodcp
      parameter (ncmax=20)        !max number of components in mixture
...
c
      ...
      implicit integer (i-n)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: DDDT
c     dll_export DDDT
c
      character*3 hpheq,heos,hmxeos,hmodcp
      parameter (ncmax=20)        !max number of components in mixture
...
c
      ...
      implicit integer (i-n)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: DHD1
c     dll_export DHD1
c
      character*3 hpheq,heos,hmxeos,hmodcp
      parameter (ncmax=20)        !max number of components in mixture
...
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: FGCTY2
c     dll_export FGCTY2
c
      implicit double precision (a-h,o-z)
      implicit integer (i-k,m,n)
...
c
      ...
      implicit integer (i-k,m,n)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: FGCTY
c     dll_export FGCTY
c
      parameter (ncmax=20)        !max number of components in mixture
      parameter (nrefmx=10)       !max number of fluids for transport ECS
...
c
      ...
      implicit integer (i-k,m,n)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: CHEMPOT
...
c
      ...
      implicit integer (i-k,m,n)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: FUGCOF
c     dll_export FUGCOF
c
      parameter (ncmax=20)        !max number of components in mixture
...
c
      ...
      implicit integer (i-k,m,n)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: ACTVY
c     dll_export ACTVY
c
      parameter (ncmax=20)        !max number of components in mixture
...
c
      ...
      implicit logical (l)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: VIRB
c     dll_export VIRB
c
      character*3 hpheq,heos,hmxeos,hmodcp
      parameter (ncmax=20)        !max number of components in mixture
...
c
      ...
      implicit logical (l)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: DBDT
c     dll_export DBDT
c
      character*3 hpheq,heos,hmxeos,hmodcp
      parameter (ncmax=20)        !max number of components in mixture
...
c
      ...
      implicit logical (l)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: DBDT2
c     dll_export DBDT2
c
      character*3 hpheq,heos,hmxeos,hmodcp
      parameter (ncmax=20)        !max number of components in mixture
...
c
      ...
      implicit logical (l)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: VIRC
c     dll_export VIRC
c
      character*3 hpheq,heos,hmxeos,hmodcp
      parameter (ncmax=20)        !max number of components in mixture
...
c
      ...
      implicit logical (l)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: DCDT
c     dll_export DCDT
c
      character*3 hpheq,heos,hmxeos,hmodcp
      parameter (ncmax=20)        !max number of components in mixture
...
c
      ...
      implicit logical (l)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: DCDT2
c     dll_export DCDT2
c
      character*3 hpheq,heos,hmxeos,hmodcp
      parameter (ncmax=20)        !max number of components in mixture
...
c
      ...
      implicit logical (l)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: VIRBA
c     dll_export VIRBA
c
      parameter (ncmax=20)        !max number of components in mixture
      parameter (nrefmx=10)       !max number of fluids for transport ECS
...
c
      ...
      implicit logical (l)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: VIRCA
c     dll_export VIRCA
c
      parameter (ncmax=20)        !max number of components in mixture
      parameter (nrefmx=10)       !max number of fluids for transport ECS
...
c
      ...
      implicit integer (i-k,m,n)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: FPV
c     dll_export FPV
c
      parameter (ncmax=20)        !max number of components in mixture
      parameter (nrefmx=10)       !max number of fluids for transport ECS
...
c
      ...
      implicit integer (i-k,m,n)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: THERM3
c     dll_export THERM3
c
      parameter (ncmax=20)        !max number of components in mixture
      parameter (nrefmx=10)       !max number of fluids for transport ECS
...
c
      ...
      implicit integer (i-k,m,n)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: HEAT
c     dll_export HEAT
c
      parameter (ncmax=20)        !max number of components in mixture
      parameter (nrefmx=10)       !max number of fluids for transport ECS
