...
c
      ...
      implicit logical (l)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: TPRHO
c     dll_export TPRHO
c
...
c
      ...
      implicit logical (l)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: TPFLSH
c     dll_export TPFLSH
c
      parameter (ncmax=20)        !max number of components in mixture
      parameter (nrefmx=10)       !max number of fluids for transport E
...
c
      ...
      implicit logical (l)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: TPFL2
c     dll_export TPFL2
c
      parameter (ncmax=20)        !max number of components in mixture
      character*1 htab,hnull
...
c
      ...
      implicit integer (i-k,m,n)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: TDFLSH
c     dll_export TDFLSH
c
      parameter (ncmax=20)        !max number of components in mixture
      parameter (nrefmx=10)       !max number of fluids for transport E
...
c
      ...
      implicit integer (i-k,m,n)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: TDFL2
c     dll_export TDFL2
c
      parameter (ncmax=20)        !max number of components in mixture
      character*255 herr
...
c
      ...
      implicit logical (l)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: PDFLSH
c     dll_export PDFLSH
c
      parameter (ncmax=20)        !max number of components in mixture
      parameter (nrefmx=10)       !max number of fluids for transport E
...
c
      ...
      implicit integer (i-k,m,n)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: PDFL1
c     dll_export PDFL1
c
      parameter (ncmax=20)        !max number of components in mixture
      character*255 herr
...
c
      ...
      implicit integer (i-k,m,n)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: PDFL2
c     dll_export PDFL2
c
      parameter (ncmax=20)        !max number of components in mixture
      character*255 herr
...
c
      ...
      implicit integer (i-k,m,n)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: PHFLSH
c     dll_export PHFLSH
c
      parameter (ncmax=20)        !max number of components in mixture
      character*255 herr
...
c
      ...
      implicit integer (i-k,m,n)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: PHFL1
c     dll_export PHFL1
c
      parameter (ncmax=20)        !max number of components in mixture
      character*255 herr
...
c
      ...
      implicit integer (i-k,m,n)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: PHFL2
c     dll_export PHFL2
c
      parameter (ncmax=20)        !max number of components in mixture
      character*255 herr
...
c
      ...
      implicit integer (i-k,m,n)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: PSFLSH
c     dll_export PSFLSH
c
      parameter (ncmax=20)        !max number of components in mixture
      character*255 herr
...
c
      ...
      implicit integer (i-k,m,n)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: PSFL1
c     dll_export PSFL1
c
      parameter (ncmax=20)        !max number of components in mixture
      character*255 herr
...
c
      ...
      implicit integer (i-k,m,n)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: PSFL2
c     dll_export PSFL2
c
      parameter (ncmax=20)        !max number of components in mixture
      character*255 herr
...
c
      ...
      implicit integer (i-k,m,n)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: PEFLSH
c     dll_export PEFLSH
c
      parameter (ncmax=20)        !max number of components in mixture
      character*255 herr
...
c
      ...
      implicit integer (i-k,m,n)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: PEFL1
c     dll_export PEFL1
c
      parameter (ncmax=20)        !max number of components in mixture
      character*255 herr
...
c
      ...
      implicit integer (i-k,m,n)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: PEFL2
c     dll_export PEFL2
c
      parameter (ncmax=20)        !max number of components in mixture
      character*255 herr
...
c
      ...
      implicit integer (i-k,m,n)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: PBFLSH
c     dll_export PBFLSH
c
      parameter (ncmax=20)        !max number of components in mixture
