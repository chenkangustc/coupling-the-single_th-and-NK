...
c
      ...
      implicit logical (l)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: SATT
c     dll_export SATT
c
...
c
      ...
      implicit integer (i-k,m,n)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: SATTEST
...
c
      ...
      implicit logical (l)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: SATP
c     dll_export SATP
c
      parameter (ncmax=20)        !max number of components in mixture
      parameter (nrefmx=10)       !max number of fluids for transport ECS
...
c
      ...
      implicit logical (l)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: SATPEST
...
c
      ...
      implicit logical (l)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: SATD
c     dll_export SATD
c
      parameter (ncmax=20)        !max number of components in mixture
      parameter (nrefmx=10)       !max number of fluids for transport ECS
...
c
      ...
      implicit logical (l)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: SATH
c     dll_export SATH
c
      parameter (ncmax=20)        !max number of components in mixture
      parameter (nrefmx=10)       !max number of fluids for transport ECS
...
c
      ...
      implicit integer (i-k,m,n)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: SATE
c     dll_export SATE
c
      parameter (ncmax=20)        !max number of components in mixture
      character*255 herr
...
c
      ...
      implicit logical (l)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: SATS
c     dll_export SATS
c
      parameter (ncmax=20)        !max number of components in mixture
      parameter (nrefmx=10)       !max number of fluids for transport ECS
...
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: CSATK
c     dll_export CSATK
c
      parameter (ncmax=20)        !max number of components in mixture
      character*255 herr
...
c
      ...
      implicit integer (i-n)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: DPTSATK
...
c
      ...
      implicit integer (i-n)
c
c     cDEC$ ATTRIBUTES DLLEXPORT::CV2PK
c     dll_export CV2PK
c
      parameter (ncmax=20)        !max number of components in mixture
