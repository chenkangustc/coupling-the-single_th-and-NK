...
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: INFO
c     dll_export INFO
c
...
c
      ...
      implicit integer (i-n)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: NAME
c     dll_export NAME
c
      parameter (ncmax=20)        !max number of components in mixture
      parameter (nrefmx=10)       !max number of fluids for transport ECS
...
c
      ...
      implicit integer (i-n)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: WMOL
c     dll_export WMOL
c
      parameter (ncmax=20)        !max number of components in mixture
      parameter (nrefmx=10)       !max number of fluids for transport ECS
...
c
      ...
      implicit integer (i-n)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: XMASS
c     dll_export XMASS
c
      parameter (ncmax=20)        !max number of components in mixture
      parameter (nrefmx=10)       !max number of fluids for transport ECS
...
c
      ...
      implicit integer (i-n)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: XMOLE
c     dll_export XMOLE
c
      parameter (ncmax=20)        !max number of components in mixture
      parameter (nrefmx=10)       !max number of fluids for transport ECS
...
c
      ...
      implicit integer (i-n)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: LIMITX
c     dll_export LIMITX
c
...
c       endif
 ...
 1020   format (' density < 0, D =',g12.5,' mol/L;')
        ...
        nchard=74
 1021   format (' density above upper limit, D =',g12.5,
...
c
      ...
      implicit integer (i-n)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: LIMITK
c     dll_export LIMITK
c
      logical lerr,lwarn,ltemp
      parameter (ncmax=20)        !max number of components in mixture
...
c
      ...
      implicit integer (i-n)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: LIMITS
c     dll_export LIMITS
c
      parameter (ncmax=20)        !max number of components in mixture
      parameter (nrefmx=10)       !max number of fluids for transport ECS
...
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: ERRMSG
c     dll_export ERRMSG
c
      character*1 htab,hnull
      common /HCHAR/ htab,hnull
...
c
      ...
      implicit integer (i-n)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: QMASS
c     dll_export QMASS
c
      parameter (ncmax=20)        !max number of components in mixture
...
c
      ...
      implicit integer (i-n)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: QMOLE
c     dll_export QMOLE
c
      parameter (ncmax=20)        !max number of components in mixture
      dimension xl(ncmax),xv(ncmax),xlkg(ncmax),xvkg(ncmax)
...
c
      implicit DOUBLE PRECISION (a-h,o-z)
c
c     cDEC$ ATTRIBUTES DLLEXPORT :: DOTFILL
