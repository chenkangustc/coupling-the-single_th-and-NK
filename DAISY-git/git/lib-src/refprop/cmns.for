     ...
     &   acf,dip,Rgas)
c     cDEC$ ATTRIBUTES DLLEXPORT, Alias: "_SETINFOdll"::SETINFOdll
C  c     cDEC$ ATTRIBUTES STDCALL, REFERENCE::SETINFOdll
...
c ======================================================================
     ...
     &                       tc,pc,Dc,Zc,acf,dip,Rgas)
      implicit double precision (a-h,o-z)
      implicit integer (i-n)
c     cDEC$ ATTRIBUTES DLLEXPORT, Alias: "_GETINFOdll"::GETINFOdll
C  c     cDEC$ ATTRIBUTES STDCALL, REFERENCE::GETINFOdll
...
c ======================================================================
     ...
     &                tsav(n0:nx)
c     cDEC$ ATTRIBUTES DLLEXPORT, Alias: "_GETCMNdll"::GETCMNdll
C  c     cDEC$ ATTRIBUTES DLLEXPORT, Alias: "_GETCMNdll@48"::GETCMNdll
C  c     cDEC$ ATTRIBUTES STDCALL, REFERENCE::GETCMNdll
c
...
c ======================================================================
     ...
     &                                  xh(n0:nx,ncppmx)
      common /CPPSAV/ cp0sav(n0:nx),cpisav(n0:nx),cptsav(n0:nx),
     &                tsav(n0:nx)
c     cDEC$ ATTRIBUTES DLLEXPORT, Alias: "_SETCMNdll"::SETCMNdll
C  c     cDEC$ ATTRIBUTES STDCALL, REFERENCE::SETCMNdll
...
c ======================================================================
     ...
     &                   n1,n2,coefhmx,n3,n4,coefcp0,coefxk)
      implicit double precision (a-h,o-z)
      implicit integer (i-n)
c     cDEC$ ATTRIBUTES DLLEXPORT::GETCMN
c     dll_export GETCMN
      parameter (ncmax=20)        !max number of components in mixture
      parameter (refmax=10)        !max number of fluids for transport ECS
      parameter (ncppmx=20)      !max number of Cp0 terms
...
c ======================================================================
     ...
     &                   n1,n2,coefhmx,n3,n4,coefcp0,coefxk)
      implicit double precision (a-h,o-z)
      implicit integer (i-n)
c     cDEC$ ATTRIBUTES DLLEXPORT::SETCMN
c     dll_export SETCMN
...
c ======================================================================
     ...
     &                      ,n3,n4,coefcp0,coefxk)
      implicit double precision (a-h,o-z)
      implicit integer (i-n)
c     cDEC$ ATTRIBUTES DLLEXPORT::GETALLCMN
...
c     cDEC$ ATTRIBUTES DLLEXPORT::GETTYPE
...
c     cDEC$ ATTRIBUTES DLLEXPORT::LIMITSET
