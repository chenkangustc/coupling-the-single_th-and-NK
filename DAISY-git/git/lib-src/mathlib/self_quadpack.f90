...
!===================================================================================================
!
!   self version of quadpack: Numerical Integration 
!---------------------------------------------------------------------------------------------------
!   Public subroutine lists:    AAAA                            is a dummy subroutine with QUADPACK documentation in its comments.
...
contains
    ...
    subroutine qag ( f, a, b, epsabs, epsrel, key, result, abserr, neval, ier )
        ...
        call qage ( f, a, b, epsabs, epsrel, key, limit, result, abserr, neval, ier, alist, blist, rlist, elist, iord, last )
    ...
    subroutine qage ( f, a, b, epsabs, epsrel, key, limit, result, abserr, neval, ier, alist, blist, rlist, elist, iord, last )
        ...
        if ( ier /= 0 .or. ( abserr <= errbnd .and. abserr /= resabs ) .or. abserr == 0.0e+00 ) then
            if ( keyf /= 1 ) then
        ...
        do last = 2, limit
            ...
            if ( errbnd < errsum ) then
                ...
                if ( MAX ( ABS ( a1 ), ABS ( b2 ) ) <= ( 1.0e+00 + c * 1.0e+03 * EPSILON ( a1 ) ) * ( ABS ( a2 ) + 1.0e+04 * tiny ( a2 ) ) ) then
                    ier = 3
                end if
            ...
            ! Call QSORT to maintain the descending ordering in the list of error estimates and select the subinterval
    ...
    subroutine qagi ( f, bound, inf, epsabs, epsrel, result, abserr, neval, ier )
        ...
        ! Determine the interval to be mapped onto (0,1). If INF = 2 the integral is computed as i = i1+i2, where
        ...
        if ( abserr <= 100.0E+00 * EPSILON ( defabs ) * defabs .and. errbnd < abserr ) then
            ier = 2
        end if
        ...
        if ( ier /= 0 .or. (abserr <= errbnd .and. abserr /= resabs ) .or. abserr == 0.0e+00 ) go to 130
        ...
        do last = 2, limit
            ...
            ! Set error flag in the case of bad integrand behavior at some points of the integration range.
            if ( MAX ( ABS(a1), ABS(b2) ) <= (1.0e+00 + 1.0e+03 * EPSILON ( a1 ) ) * ( ABS(a2) + 1.0e+03 * tiny ( a2 ) )) then
                ier = 4
            end if
            ...
            ! The smallest interval has the largest error. before bisecting decrease the SUM of the errors over the
...
110     continue
        ...
        if ( ksgn == (-1) .and. MAX ( ABS(result), ABS(area) ) <=  defabs * 1.0e-02) go to 130
        
        if ( 1.0e-02 > (result/area) .or. (result/area) > 1.0e+02 .or. errsum > ABS(area)) then
            ier = 6
        end if
...
130     continue
    ...
    subroutine qagp ( f, a, b, npts2, points, epsabs, epsrel, result, abserr, neval, ier )
        ...
        else if ( limit <= npts .or. ( epsabs < 0.0e+00 .and. epsrel < 0.0e+00) ) then
            ier = 6
            return
        ...
        if ( abserr <= 1.0e+02 * EPSILON ( resabs ) * resabs .and. abserr > errbnd ) then
            ier = 2
        end if
        ...
        do last = npts2, limit
            ...
            if ( defab1 /= error1 .and. defab2 /= error2 ) then
                if ( ABS ( rlist ( maxerr ) - area12 ) <= 1.0e-05 * ABS(area12) .and. erro12 >= 9.9e-01 * errmax ) then
                    if ( extrap ) then
                        iroff2 = iroff2+1
                    else
                        iroff1 = iroff1+1
            ...
            ! Before bisecting decrease the SUM of the errors over the larger intervals (erlarg) and perform extrapolation.
...
210     continue
    ...
    subroutine qags ( f, a, b, epsabs, epsrel, result, abserr, neval, ier )
        ...
        ! The dimension of rlist2 is determined by the value of limexp in QEXTR (rlist2 should be of dimension (limexp+2) at least).
        ! Test on validity of parameters.
        ier = 0
        neval = 0
        last = 0
        ...
        if ( abserr <= 1.0e+02 * EPSILON ( defabs ) * defabs .and. abserr > errbnd ) then
            ier = 2
        end if
        ...
        if ( ier /= 0 .or. (abserr <= errbnd .and. abserr /= resabs ) .or. abserr == 0.0e+00 ) go to 140
        ...
        do last = 2, limit
            ...
            if ( ABS ( rlist(maxerr) - area12) > 1.0e-05 * ABS(area12) .or. erro12 < 9.9e-01 * errmax ) go to 10
...
15          continue
            ...
            ! in the list of error estimates and select the subinterval with nrmax-th largest error estimate (to be bisected next).
            call qsort ( limit, last, maxerr, errmax, elist, iord, nrmax )
...
90          continue
        ...
        !  et final result and error estimate.
        if ( abserr == HUGE ( abserr ) ) then
            go to 115
        end if
...
140     continue
    ...
    subroutine qawce ( f, a, b, c, epsabs, epsrel, limit, result, abserr, neval, ier, alist, blist, rlist, elist, iord, last )
        ...
        do last = 2, limit
            ...
            if ( ABS ( rlist(maxerr)-area12) < 1.0e-05 * ABS(area12) .and. erro12 >= 9.9e-01 * errmax .and. krule == 0 )  iroff1 = iroff1+1
...
70      continue 
    ...
    subroutine qawf ( f, a, omega, integr, epsabs, result, abserr, neval, ier )
        ...
        call qawfe ( f, a, omega, integr, epsabs, limlst, limit, maxp1, result, abserr, neval, ier, rslst, erlst, ierlst, lst, alist, blist, rlist, elist, iord, nnlog, chebmo )
    ...
    subroutine qawfe (f, a, omega, integr, epsabs, limlst, limit, maxp1, result, abserr, neval, ier, rslst, erlst, ierlst, lst, alist, blist, rlist, elist, iord, nnlog, chebmo)
        ...
        ! The dimension of  psum  is determined by the value of limexp in QEXTR (psum must be of dimension (limexp+2) at least).
        ! Test on validity of parameters.
        result = 0.0e+00
        abserr = 0.0e+00
        neval = 0
        ...
        do lst = 1, limlst
            ...
            call qfour (f, c1, c2, omega, integr, epsa, 0.0e+00, limit, lst, maxp1, rslst(lst), erlst(lst), nev, ierlst(lst), alist, blist, rlist, elist, iord, nnlog, momcom, chebmo)
            ...
            if ( abseps <= abserr .or. lst == 3 ) then
                ...
                ! If IER is not 0, check whether direct result (partial SUM) or extrapolated result yields the best integral approximation
...
80      continue
    ...
    subroutine qawo ( f, a, b, omega, integr, epsabs, epsrel, result, abserr, neval, ier )
        ...
        call qfour (f, a, b, omega, integr, epsabs, epsrel, limit, 1, maxp1, result, abserr, neval, ier, alist, blist, rlist, elist, iord, nnlog, momcom, chebmo)
    ...
    subroutine qaws ( f, a, b, alfa, beta, integr, epsabs, epsrel, result, abserr, neval, ier )
        ...
        call qawse ( f, a, b, alfa, beta, integr, epsabs, epsrel, limit, result, abserr, neval, ier, alist, blist, rlist, elist, iord, last )
    ...
    subroutine qawse ( f, a, b, alfa, beta, integr, epsabs, epsrel, limit, result, abserr, neval, ier, alist, blist, rlist, elist, iord, last )
        ...
        if ( b <= a .or. (epsabs < 0.0e+00 .and. epsrel < 0.0e+00) .or. alfa <= (-1.0e+00) .or. beta <= (-1.0e+00) .or. integr < 1 .or. integr > 4 .or. limit < 2 ) then
            ier = 6
            return
        end if
        ...
        do last = 3, limit
            ...
            if ( errsum > errbnd ) then
                ...
                ! Set error flag in the case that the number of interval bisections exceeds limit.
                if ( last == limit ) then
                    ier = 1
                end if
                ...
                ! Set error flag in the case of bad integrand behavior at interior points of integration range.
    ...
    subroutine qc25o ( f, a, b, omega, integr, nrmom, maxp1, ksave, result, abserr, neval, resabs, resasc, momcom, chebmo )
        ...
        ! Compute the integral using the 15-point Gauss-Kronrod formula if the value of the parameter in the integrand
        ! is small or if the length of the integration interval is less than (bb-aa)/2**(maxp1-2), where (aa,bb) is the
        ...
        v(3) = (3.2e+01*(par2-1.2e+01)*cospar+(2.0e+00 * ((par2-8.0e+01)*par2+1.92e+02)*sinpar) / parint)/(par2*par2)
        ac = 8.0e+00*cospar
        ...
        ! Compute the Chebyshev moments as the solutions of a boundary value problem with one initial value (v(3)) and one end value computed
        ...
        ass = parint * sinpar
        asap = (((((2.10e+02*par2-1.0e+00)*cospar-(1.05e+02*par2-6.3e+01)*ass)/an2-(1.0e+00-1.5e+01*par2)*cospar +1.5e+01*ass)/an2-cospar+3.0e+00*ass)/an2-cospar)/an2
        v(noequ+3) = v(noequ+3)-2.0e+00*asap*par2*(an-1.0e+00)* (an-2.0e+00)
...
90      continue
        ...
        v(2) = (1.8e+01-4.8e+01/par2)*sinpar/par2 +(-2.0e+00+4.8e+01/par2)*cospar/parint
        ...
        if ( ABS(parint) <= 2.4e+01 ) then
            do k = 3, 12
                an = k
                chebmo(m,2*k) = -sinpar/(an*(2.0e+00*an-2.0e+00))-2.5e-01*parint*(v(k+1)/an-v(k)/(an-1.0e+00))
            end do
...
140     continue
        ...
        ress12 = 0.0e+00
        estc = ABS ( cheb24(25)*chebmo(m,25))+ABS((cheb12(13)- cheb24(13))*chebmo(m,13) )
        ests = 0.0e+00
        k = 11
    ...
    subroutine qc25s ( f, a, b, bl, br, alfa, beta, ri, rj, rg, rh, result, abserr, resasc, integr, neval )
        ...
        if ( br == b .and. (beta /= 0.0e+00 .or. integr == 3 .or. integr == 4)) then 
            go to 140
        end if
        ...
        ! Compute the Chebyshev series expansion of the function f1 = (0.5*(b+b-br-a)-0.5*(br-a)*x)**beta*f(0.5*(br-a)*x+0.5*(br+a))
10      continue
        ...
        ! Compute the Chebyshev series expansion of the function F4 = f1*LOG(0.5*(b+b-br-a)-0.5*(br-a)*x)
70      continue
...
130     continue
        ...
        ! Compute the Chebyshev series expansion of the function f2 = (0.5*(b+bl-a-a)+0.5*(b-bl)*x)**alfa*f(0.5*(b-bl)*x+0.5*(b+bl))
140     continue
        ...
        ! Compute the Chebyshev series expansion of the function f3 = f2*LOG(0.5*(b-bl)*x+0.5*(b+bl-a-a))
200     continue
...
270     continue
    ...
    subroutine qextr ( n, epstab, result, abserr, res3la, nres )
        ...
        do i = 1, newelm
            ...
            ! Test to detect irregular behavior in the table, and eventually omit a part of the table adjusting the value of N.
...
30          continue
    ...
    subroutine qfour (f, a, b, omega, integr, epsabs, epsrel, limit, icall, maxp1, result, abserr, neval, ier, alist, blist, rlist, elist, iord, nnlog, momcom, chebmo)
        ...
        if ( (integr /= 1.and.integr /= 2) .or. (epsabs < 0.0e+00.and. epsrel < 0.0e+00) .or. icall < 1 .or. maxp1 < 1 ) then
            ier = 6
            return
        end if
        ...
        do last = 2, limit
            ...
            if ( ABS(rlist(maxerr)-area12) > 1.0e-05*ABS(area12) .or. erro12 < 9.9e-01*errmax ) go to 20
...
50          continue
            ...
            ! (we do this if we integrate over the next interval with use of a Gauss-Kronrod rule - see QC25O).
            small = small*5.0e-01
...
165     continue
        ...
        if ( ksgn == (-1) .and. MAX ( ABS(result),ABS(area)) <= defabs*1.0e-02 ) go to 190
        if ( 1.0e-02 > (result/area) .or. (result/area) > 1.0e+02 .or. errsum >= ABS(area) ) ier = 6
...
200     continue
    ...
    subroutine qk15 ( f, a, b, result, abserr, resabs, resasc )
        ...
        ! Compute the 15-point Kronrod approximation to the integral, and estimate the absolute error.
        fc = f(centr)
        resg = fc*wg(4)
        resk = fc*wgk(8)
        resabs = ABS(resk)
    ...
    subroutine qk21 ( f, a, b, result, abserr, resabs, resasc )
        ...
        data xgk(1),xgk(2),xgk(3),xgk(4),xgk(5),xgk(6),xgk(7),xgk(8), xgk(9),xgk(10),xgk(11)/                 &
        ...
        data wgk(1),wgk(2),wgk(3),wgk(4),wgk(5),wgk(6),wgk(7),wgk(8), wgk(9),wgk(10),wgk(11)/                 &
    ...
    subroutine qk31 ( f, a, b, result, abserr, resabs, resasc )
        ...
        data xgk(1),xgk(2),xgk(3),xgk(4),xgk(5),xgk(6),xgk(7),xgk(8), xgk(9),xgk(10),xgk(11),xgk(12),xgk(13),xgk(14),xgk(15),xgk(16)/   &
        ...
        data wgk(1),wgk(2),wgk(3),wgk(4),wgk(5),wgk(6),wgk(7),wgk(8), wgk(9),wgk(10),wgk(11),wgk(12),wgk(13),wgk(14),wgk(15),wgk(16)/   &
        ...
        ! Compute the 31-point Kronrod approximation to the integral, and estimate the absolute error.
        fc = f(centr)
        resg = wg(8)*fc
        resk = wgk(16)*fc
        resabs = ABS(resk)
        ...
        if ( resasc /= 0.0e+00.and.abserr /= 0.0e+00) abserr = resasc*MIN ( 1.0e+00,(2.0e+02*abserr/resasc)**1.5e+00)
    ...
    subroutine qk41 ( f, a, b, result, abserr, resabs, resasc )
        ...
        data xgk(1),xgk(2),xgk(3),xgk(4),xgk(5),xgk(6),xgk(7),xgk(8), xgk(9),xgk(10),xgk(11),xgk(12),xgk(13),xgk(14),xgk(15),xgk(16), xgk(17),xgk(18),xgk(19),xgk(20),xgk(21)/ &
                                                                                ...
                                                                                &   0.0e+00               /
        data wgk(1),wgk(2),wgk(3),wgk(4),wgk(5),wgk(6),wgk(7),wgk(8), wgk(9),wgk(10),wgk(11),wgk(12),wgk(13),wgk(14),wgk(15),wgk(16), wgk(17),wgk(18),wgk(19),wgk(20),wgk(21)/ &
        ...
        ! Compute 41-point Gauss-Kronrod approximation to the the integral, and estimate the absolute error.
        resg = 0.0e+00
        fc = f(centr)
        resk = wgk(21)*fc
        resabs = ABS(resk)
    ...
    subroutine qk51 ( f, a, b, result, abserr, resabs, resasc )
        ...
        data xgk(1),xgk(2),xgk(3),xgk(4),xgk(5),xgk(6),xgk(7),xgk(8), xgk(9),xgk(10),xgk(11),xgk(12),xgk(13),xgk(14)/ &
        ...
        data xgk(15),xgk(16),xgk(17),xgk(18),xgk(19),xgk(20),xgk(21), xgk(22),xgk(23),xgk(24),xgk(25),xgk(26)/ &
        ...
        data wgk(1),wgk(2),wgk(3),wgk(4),wgk(5),wgk(6),wgk(7),wgk(8), wgk(9),wgk(10),wgk(11),wgk(12),wgk(13),wgk(14)/ &
        ...
        data wgk(15),wgk(16),wgk(17),wgk(18),wgk(19),wgk(20),wgk(21), wgk(22),wgk(23),wgk(24),wgk(25),wgk(26)/ &
        ...
        data wg(1),wg(2),wg(3),wg(4),wg(5),wg(6),wg(7),wg(8),wg(9),wg(10), wg(11),wg(12),wg(13)/ &
        ...
        ! Compute the 51-point Kronrod approximation to the integral, and estimate the absolute error.
        fc = f(centr)
        resg = wg(13)*fc
        resk = wgk(26)*fc
        resabs = ABS(resk)
    ...
    subroutine qk61 ( f, a, b, result, abserr, resabs, resasc ) 
        ...
        data xgk(1),xgk(2),xgk(3),xgk(4),xgk(5),xgk(6),xgk(7),xgk(8), xgk(9),xgk(10)/ &
        ...
        data xgk(11),xgk(12),xgk(13),xgk(14),xgk(15),xgk(16),xgk(17), xgk(18),xgk(19),xgk(20)/ &
        ...
        data xgk(21),xgk(22),xgk(23),xgk(24),xgk(25),xgk(26),xgk(27), xgk(28),xgk(29),xgk(30),xgk(31)/ &
                                                                                ...
                                                                                &   0.0e+00                   /
        data wgk(1),wgk(2),wgk(3),wgk(4),wgk(5),wgk(6),wgk(7),wgk(8), wgk(9),wgk(10)/ &
        ...
        data wgk(11),wgk(12),wgk(13),wgk(14),wgk(15),wgk(16),wgk(17), wgk(18),wgk(19),wgk(20)/ &
        ...
        data wgk(21),wgk(22),wgk(23),wgk(24),wgk(25),wgk(26),wgk(27), wgk(28),wgk(29),wgk(30),wgk(31)/ &
...
70      continue
    ...
    subroutine qng ( f, a, b, epsabs, epsrel, result, abserr, neval, ier )
        ...
        !  the following data statements contain the abscissae and weights of the integration rules used.
        !
        ...
        !  w87a    weights of the 87-point formula for abscissae x1, x2 and x3
        ...
        data x3(1),x3(2),x3(3),x3(4),x3(5),x3(6),x3(7),x3(8),x3(9),x3(10), x3(11)/ &
        ...
        data x4(1),x4(2),x4(3),x4(4),x4(5),x4(6),x4(7),x4(8),x4(9),x4(10), x4(11),x4(12),x4(13),x4(14),x4(15),x4(16),x4(17),x4(18),x4(19), x4(20),x4(21),x4(22)/  &
                                                                                &   9.999029772627292e-01,                            &
        ...
        data w43a(1),w43a(2),w43a(3),w43a(4),w43a(5),w43a(6),w43a(7), w43a(8),w43a(9),w43a(10)/ &
                                                                                &   1.629673428966656e-02,                            &
        ...
        data w43b(1),w43b(2),w43b(3),w43b(4),w43b(5),w43b(6),w43b(7), w43b(8),w43b(9),w43b(10),w43b(11),w43b(12)/ &
        ...
        data w87a(1),w87a(2),w87a(3),w87a(4),w87a(5),w87a(6),w87a(7), w87a(8),w87a(9),w87a(10),w87a(11),w87a(12),w87a(13),w87a(14), w87a(15),w87a(16),w87a(17),w87a(18),w87a(19),w87a(20),w87a(21)/ &
        ...
        data w87b(1),w87b(2),w87b(3),w87b(4),w87b(5),w87b(6),w87b(7), w87b(8),w87b(9),w87b(10),w87b(11),w87b(12),w87b(13),w87b(14), w87b(15),w87b(16),w87b(17),w87b(18),w87b(19),w87b(20),w87b(21), w87b(22),w87b(23)/            2.741455637620724e-04, & 
    ...
    subroutine qsort ( limit, last, maxerr, ermax, elist, iord, nrmax )
        ...
        ! This part of the routine is only executed if, due to a difficult integrand, subdivision increased the error
        ! estimate. in the normal case the insert procedure should start after the nrmax-th largest error estimate.
        errmax = elist(maxerr)
